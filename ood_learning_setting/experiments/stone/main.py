...
def get_config():
    ...
    parser.add_argument('--group', type=float, default=4)
    parser.add_argument('--sd_lr', type=float, default=1e-4)
    ...
    # logger = get_logger(log_dir, __name__, 'record_s{}_{}_{}.log'.format(args.seed, args.group, args.sd_lr))
    # logger = get_logger(log_dir, __name__, 'record_s{}_sample{}_step{}.log'.format(args.seed, args.sample_num, args.update_step))
...
def main():
    ...
    if args.mode == 'train':
        ...
        # engine.evaluate_with_ttc_random(args.mode)
        # engine.evaluate_with_ttc_retrieval(args.mode)
        # engine.evaluate_with_ttc_n(args.mode, args.sample_num, args.update_step)

...
def generate_train_val_test(args):
    ...
    num_samples = len(idx)
    if args.dataset=='pemsbay' or args.dataset=='metrla':
    ...
    # split idx
    if args.fewshot!=100:
        idx_train = idx[:round(num_samples * args.fewshot / 100)]
    else:
    ...
    # normalize
    x_train = data[:idx_train[-1] - args.seq_length_x + 1, :, 0]
    ...
    if args.fewshot!=100:
        out_dir = out_dir + f'-fewshot{args.fewshot}'
...
if __name__ == '__main__':
    ...
    parser.add_argument('--fewshot', type=int, default=6, help='create few-shot percent datasets, 100 means full-shot')
    parser.add_argument('--years', type=str, default='2017', help='if use data from multiple years, please use underline to separate them, e.g., 2018_2019')
